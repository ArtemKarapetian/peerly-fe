...
const demoAssignments: DemoAssignment[] = [
  { id: "a1", courseId: "c1", title: "Лендинг-страница", description: "Создать адаптивную лендинг-страницу", dueDate: new Date("2025-02-15"), reviewCount: 3, status: "published", rubricId: "r1" },
  { id: "a2", courseId: "c1", title: "REST API", description: "Разработать REST API для блога", dueDate: new Date("2025-03-01"), reviewCount: 2, status: "published" },
];

export const assignmentRepo = {
  getAll: (): DemoAssignment[] => demoAssignments,
  getByCourse: (courseId: string): DemoAssignment[] => demoAssignments.filter((a) => a.courseId === courseId),
