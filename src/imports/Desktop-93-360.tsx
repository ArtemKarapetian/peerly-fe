...
function LoginButton() {
  return (
    <div className="bg-[#21214f] content-stretch flex items-center justify-center p-[12px] relative rounded-[51.575px] shrink-0" data-name="Login button">
      <p className="css-4hzbpn font-['Work_Sans:Medium','Noto_Sans:Medium',sans-serif] font-medium leading-[1.1] relative shrink-0 text-[12px] text-center text-white tracking-[-0.54px] w-[138px]">Вход</p>
    </div>
  );
}
...
function Login() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0" data-name="Login">
      <p className="css-ew64yg font-['Work_Sans:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[1.05] relative shrink-0 text-[#21214f] text-[40px] tracking-[-1.8px]">Вход в аккаунт</p>
      <LoginField />
      <Password />
      <LoginButton />
      <p className="css-ew64yg font-['DM_Sans:Medium','Noto_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#21214f] text-[15px] tracking-[-0.3px]" style={{ fontVariationSettings: "'opsz' 14" }}>
        <span className="leading-none text-[#767692]">{`Ещё нет аккаунта? `}</span>
        <span className="leading-none">Зарегистрироваться.</span>
      </p>
    </div>
  );
}
...
function HeroSection() {
  return (
    <section className="bg-white h-[589px] relative rounded-bl-[16px] rounded-br-[16px] shrink-0 w-full" data-name="Hero section">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center px-[40px] py-[100px] relative size-full">
          <Login />
        </div>
      </div>
    </section>
