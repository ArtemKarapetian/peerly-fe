...
export function ReviewSort({ direction, onToggle }: ReviewSortProps) {
  ...
  return (
    <button
      onClick={onToggle}
      className="inline-flex items-center gap-2 px-4 py-2 rounded-[8px] text-[14px] font-medium bg-muted text-muted-foreground hover:bg-surface-hover transition-colors"
