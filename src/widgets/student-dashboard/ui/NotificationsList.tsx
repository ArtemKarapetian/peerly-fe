  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-6">
        ...
        <p className="text-[13px] text-[#767692]">Нет новых уведомлений</p>
      </div>
    );
  }
          ...
          return (
            ...
            >
              <div className="flex items-start gap-2.5">
                {/* Icon */}
                <div
                  className={`w-7 h-7 ${color} rounded-[6px] flex items-center justify-center shrink-0`}
                >
                ...
                <div className="flex-1 min-w-0">
                  <div
                    className={`text-[13px] mb-1 leading-[1.4] tracking-[-0.2px] ${notification.isRead ? "text-[#767692]" : "text-[#21214f] font-medium"}`}
                  >
                    {notification.title}
                  </div>
                  <div className="text-[12px] text-[#767692]">{notification.time}</div>
                </div>
