    ...
    <div className="bg-[#f9f9f9] rounded-[16px] p-4 desktop:p-6">
      ...
      <div className="space-y-4">
        <p className="text-[14px] desktop:text-[16px] font-['Work_Sans:Regular',sans-serif] tracking-[-0.48px] text-[#4b4963] leading-[1.6]">
          Написать аналитическое эссе на тему "Влияние цифровых технологий на современное
          образование". В работе необходимо проанализировать как минимум три аспекта цифровизации
          образования, привести примеры из практики и сделать обоснованные выводы.
        </p>

        <p className="text-[14px] desktop:text-[16px] font-['Work_Sans:Regular',sans-serif] tracking-[-0.48px] text-[#4b4963] leading-[1.6]">
          Работа должна включать введение, основную часть с аргументацией и заключение. Обязательно
          использование академических источников с правильным оформлением ссылок.
        </p>
