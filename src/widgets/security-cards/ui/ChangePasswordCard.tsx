          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-3 border-2 border-border rounded-md text-15 text-foreground bg-card focus:border-accent focus:outline-none transition-colors"
