        ...
        <table className="w-full">
          <thead>
            <tr className="bg-muted border-b-2 border-border">
              <th className="text-left px-4 desktop:px-6 py-4 text-13 font-medium text-muted-foreground uppercase tracking-wide">
              ...
              <th className="text-right px-4 desktop:px-6 py-4 text-13 font-medium text-muted-foreground uppercase tracking-wide">
          ...
          <tbody>
            {grades.map((grade) => (
              ...
              >
                ...
                <td className="px-4 desktop:px-6 py-4">
                  <span
                    className={`inline-flex items-center px-3 py-1 rounded-2sm text-13 font-medium ${
                ...
                <td className="px-4 desktop:px-6 py-4 text-right">
                  {grade.isScoreLocked ? (
                    ...
                    <span
                      className={`text-base font-semibold ${getScoreColor(grade.score, grade.maxScore)}`}
                    >
                      {grade.score}
                    </span>
                  ) : (
          ...
          >
            <div className="flex items-start justify-between gap-2">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <span
                  className={`inline-flex items-center px-2.5 py-1 rounded-2sm text-xs font-medium ${
                    statusColors[grade.status]
                  }`}
                >
                  {statusLabels[grade.status]}
