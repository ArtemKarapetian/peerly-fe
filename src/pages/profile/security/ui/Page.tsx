import { Lock, Shield, Smartphone, CheckCircle, AlertCircle, Mail } from "lucide-react";
import { useState } from "react";

import { ROUTES } from "@/shared/config/routes.ts";
import { getFeatureFlags, setFeatureFlag } from "@/shared/lib/feature-flags";
...
export default function SecurityPage() {
  ...
  return (
    <AppShell title="Security">
      <Breadcrumbs items={[{ label: "Settings", href: ROUTES.settings }, { label: "Security" }]} />
              ...
              <div className="flex items-start gap-3 flex-1">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 p-3 bg-[#fff5e6] border-2 border-[#ff9800] rounded-[12px]">
                    ...
                    <div className="flex-1">
                      <p className="text-[14px] text-[#ff9800] font-medium">Email не подтверждён</p>
        ...
        <div className="bg-white border-2 border-[#e6e8ee] rounded-[20px] p-6 mb-6">
          ...
          {twoFactorEnabled && (
            <div className="mt-4 p-4 bg-[#e8f5e9] border-2 border-[#4caf50] rounded-[12px] flex items-start gap-3">
              ...
              <div>
                <p className="text-[14px] text-[#4caf50] font-medium mb-1">2FA включена</p>
              ...
              <div key={idx} className="p-4 border-2 border-[#e6e8ee] rounded-[12px]">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-[13px] text-[#767692] mb-1">📍 {session.location}</p>
                    <p className="text-[13px] text-[#767692]">
