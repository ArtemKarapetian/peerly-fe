import { Clock, Eye, FileText, EyeOff, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="bg-white border-2 border-[#e6e8ee] hover:border-[#d2def8] rounded-[16px] p-4 desktop:p-5 transition-all group">
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <p className={`text-[13px] desktop:text-[14px] ${deadlineSoon ? 'text-[#ff9800] font-medium' : 'text-[#4b4963]'}`}>
      ...
      {review.workSubmittedAt && (
        <div className="flex items-center gap-2 mb-4">
          ...
          <p className="text-[13px] text-[#767692]">
            Работа сдана: {review.workSubmittedAt}
          </p>
        </div>
      )}
