...
export function TeacherPlaceholderPage({
    ...
    return (
        <AppShell title={title}>
            ...
            <div className="mt-6">
                <div
                    className="bg-white border-2 border-[#e6e8ee] rounded-[20px] p-8 text-center max-w-[600px] mx-auto">
                    <div
                        className="w-16 h-16 bg-[#e9f5ff] rounded-[16px] flex items-center justify-center mx-auto mb-4">
                        <Icon className="w-8 h-8 text-[#5b8def]"/>
                    </div>
                    <h1 className="text-[28px] font-medium text-[#21214f] tracking-[-0.5px] mb-3">
                        {title}
                    </h1>
                    <p className="text-[16px] text-[#767692] leading-[1.6] mb-6">
                        {description}
                    </p>
