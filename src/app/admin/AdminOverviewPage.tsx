...
export default function AdminOverviewPage() {
  ...
  // Get data from store
  const allUsers = demoDataStore.getUsers();
  const allCourses = demoDataStore.getCourses();
  const allPlugins = demoDataStore.getPlugins();
  ...
  // Demo plugin health
  const pluginHealth: PluginHealth[] = allPlugins.map(plugin => ({
    id: plugin.id,
    name: plugin.name,
      ...
      <div className="mt-6">
          ...
          <div className="flex items-start justify-between gap-4 mb-4">
            <div className="flex-1">
              ...
              <p className="text-[16px] text-[#767692]">
                Мониторинг и управление системой Peerly
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white border-2 border-[#e6e8ee] rounded-[16px] p-6">
            ...
            <p className="text-[13px] text-[#767692] uppercase tracking-wide mb-1">Всего пользователей</p>
          ...
          <div className="bg-white border-2 border-[#e6e8ee] rounded-[16px] p-6">
            ...
            <p className="text-[13px] text-[#767692] uppercase tracking-wide mb-1">Активных курсов</p>
            <p className="text-[32px] font-medium text-[#21214f] tracking-[-0.5px]">
              {activeCourses}
            </p>
          ...
          <div className="bg-white border-2 border-[#e6e8ee] rounded-[16px] p-6">
            ...
            <p className="text-[13px] text-[#767692] uppercase tracking-wide mb-1">Задач в очереди</p>
            <p className="text-[32px] font-medium text-[#21214f] tracking-[-0.5px]">
              {queueStats.running}
            </p>
            <p className="text-[12px] text-[#767692] mt-2">
              {queueStats.pending} в ожидании
            </p>
          </div>
          ...
          <div className="bg-white border-2 border-[#e6e8ee] rounded-[16px] p-6">
            ...
            <p className="text-[13px] text-[#767692] uppercase tracking-wide mb-1">Статус плагинов</p>
            <p className="text-[32px] font-medium text-[#21214f] tracking-[-0.5px]">
              {healthyPlugins}/{pluginHealth.length}
            </p>
            <div className="flex items-center gap-2 mt-2 text-[12px]">
              {warningPlugins > 0 && (
                <span className="text-[#ff9800]">{warningPlugins} ⚠️</span>
              )}
              {errorPlugins > 0 && (
                <span className="text-[#d4183d]">{errorPlugins} ❌</span>
              )}
          ...
          <div className="bg-white border-2 border-[#e6e8ee] rounded-[20px] p-6">
            ...
            <div className="space-y-3">
              {pluginHealth.slice(0, 3).map(plugin => (
                <div key={plugin.id} className="flex items-center justify-between p-3 bg-[#f9f9f9] rounded-[8px]">
                  <div className="flex-1">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {quickLinks.map(link => {
              ...
              return (
                ...
                >
                  <div className={`w-12 h-12 ${link.color} rounded-[12px] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
        ...
        <div className="mt-6 bg-white border-2 border-[#e6e8ee] rounded-[20px] p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 hover:bg-[#fafbfc] rounded-[8px] transition-colors">
              ...
              <div className="flex-1">
                <p className="text-[14px] text-[#21214f]">Новая организация создана: "{currentOrg.name}"</p>
            ...
            <div className="flex items-start gap-3 p-3 hover:bg-[#fafbfc] rounded-[8px] transition-colors">
              ...
              <div className="flex-1">
                <p className="text-[14px] text-[#21214f]">Плагин обновлён: "Plagiarism Checker v2.1"</p>
            ...
            <div className="flex items-start gap-3 p-3 hover:bg-[#fafbfc] rounded-[8px] transition-colors">
              ...
              <div className="flex-1">
                <p className="text-[14px] text-[#21214f]">Резервное копирование завершено успешно</p>
