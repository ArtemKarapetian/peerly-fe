...
export function Router() {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      const extensionRequestMatch = hash.match(/^\/courses\/([^/]+)\/tasks\/([^/]+)\/extension-request$/);
  ...
  const protectedPaths = [
    '/dashboard', '/courses', '/course/', '/task/', '/reviews', '/gradebook', '/inbox',
    '/teacher/', '/admin/'
  ];
  ...
  if (currentHash.startsWith('/teacher/course/')) return <TeacherCourseDetailsPage courseId={params.courseId} />;
  ...
  if (currentHash.startsWith('/teacher/peer-session-settings/')) return <TeacherPeerSessionSettingsPage assignmentId={params.assignmentId} />;
