...
export default function AppealsPage() {
  ...
  return (
    <AppShell title="Appeals">
      <Breadcrumbs items={['Student', 'Appeals']} />
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-[16px] text-[#767692]">
              История запросов на пересмотр оценок
            </p>
          </div>
        </div>
            ...
            <div key={appeal.id} className="bg-white border-2 border-[#e6e8ee] rounded-[20px] p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <p className="text-[15px] text-[#767692] mb-1">
                    Задание: {appeal.assignment}
                  </p>
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-4">
                ...
                <div className="p-4 bg-[#f9f9f9] rounded-[12px]">
                  ...
                  <p className={`text-[24px] font-medium ${
                    ...
                    {appeal.appealGrade
                      ? (appeal.appealGrade > appeal.reviewerGrade ? '+' : '') + (appeal.appealGrade - appeal.reviewerGrade)
                      : '—'}
                  </p>
                </div>
              </div>
        ...
        <div className="mt-6 bg-[#e9f5ff] border-2 border-[#5b8def] rounded-[16px] p-4">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-[13px] text-[#767692]">
                Апелляция рассматривается преподавателем в течение 3-5 рабочих дней. 
                Вы можете подать апелляцию в течение 7 дней после получения оценки.
              </p>
            </div>
          </div>
        </div>
