...
export default function DeleteAccountPage() {
  ...
  const textMatches = confirmText.toUpperCase() === 'УДАЛИТЬ' || confirmText.toUpperCase() === 'DELETE';
        ...
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <div className="bg-muted/50 rounded-lg p-4 text-left">
            <p className="text-sm text-muted-foreground">
              Мы сожалеем, что вы покидаете нас. Если вы передумаете, вы всегда можете создать новый аккаунт.
            </p>
          </div>
      ...
      <div className="max-w-[800px]">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="bg-destructive/5 dark:bg-destructive/10 border-2 border-destructive/20 rounded-[20px] p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Это действие необратимо и приведёт к безвозвратной потере всех ваших данных, включая оценки, отзывы и доступ к курсам.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card border border-border rounded-[20px] p-6">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-muted-foreground">
                  <strong className="text-foreground">Потеря доступа:</strong> вы больше не сможете войти в систему
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-destructive rounded-full mt-2 flex-shrink-0" />
                <span className="text-sm text-muted-foreground">
                  <strong className="text-foreground">Удаление работ:</strong> все ваши сабмишены и файлы будут удалены
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-destructive rounded-full mt-2 flex-shrink-0" />
                <span className="text-sm text-muted-foreground">
                  <strong className="text-foreground">Потеря отзывов:</strong> все написанные вами рецензии будут удалены
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-destructive rounded-full mt-2 flex-shrink-0" />
                <span className="text-sm text-muted-foreground">
                  <strong className="text-foreground">История оценок:</strong> весь ваш прогресс и оценки будут потеряны
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-destructive rounded-full mt-2 flex-shrink-0" />
                <span className="text-sm text-muted-foreground">
                  <strong className="text-foreground">Личные данные:</strong> вся информация профиля и настройки удаляются
                </span>
              </li>
            </ul>
            ...
            <div className="mt-6 p-4 bg-blue-500/5 dark:bg-blue-500/10 border border-blue-500/20 rounded-[12px]">
              <p className="text-sm text-foreground/80">
                <strong>Важно:</strong> Если вы уже провели peer review для других студентов, удаление может повлиять на их оценки. Рекомендуем сначала связаться с преподавателем курса.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 bg-muted/50 rounded-lg border border-border">
            <p className="text-sm text-muted-foreground">
              <strong className="text-foreground">Нужна помощь?</strong> Если у вас возникли проблемы или вы хотите обсудить альтернативы, свяжитесь с нами:{' '}
